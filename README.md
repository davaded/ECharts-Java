# ECharts-Java
这是一个针对EChartsV5版本的Java类库，实现了所有ECharts中的Json结构对应的Java对象，并且可以很方便的创建Option,Series等
参考自：[abel533](https://github.com/abel533/ECharts)
# ECharts - Java类库
